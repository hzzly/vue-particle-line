  ...
  <table>
    ...
    <tbody>
      <tr v-for="(item,index) in list" :key="index">
        ...
        <td>{{item.phone}}</td>
        <td>{{item.htype}}</td>
        <td v-show="item.rprice">{{item.rprice}}</td>
        <td v-show="item.bprice">{{item.bprice}}</td>
        <td>{{item.jarea}}</td>
        <td>{{item.decoratetype}}</td>
        <td v-show="item.hadress">{{item.hadress}}</td>
        <td v-show="item.haddress">{{item.haddress}}</td>
        <td v-show="item.isrent">{{item.isrent | isRent}}</td>
        <td v-show="item.isbuy">{{item.isbuy | isBuy}}</td>
